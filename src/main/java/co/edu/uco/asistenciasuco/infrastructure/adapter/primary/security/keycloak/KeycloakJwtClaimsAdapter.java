package co.edu.uco.asistenciasuco.infrastructure.adapter.primary.security.keycloak;
 ...
 * lanza error.</p>
 */
public final class KeycloakJwtClaimsAdapter implements JwtClaimsAdapter {
    ...
    public KeycloakJwtClaimsAdapter(final String apiClientId, final String userIdClaim) {
    ...
    public Set<InstitutionalRole> extractRoles(final Jwt jwt) {
        ...
        return roles.stream()
                ...
                .map(KeycloakJwtClaimsAdapter::toInstitutionalRole)
