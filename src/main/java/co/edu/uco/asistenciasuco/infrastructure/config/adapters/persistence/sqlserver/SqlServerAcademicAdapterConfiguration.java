...
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.AreaSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.AsignaturaDocenteSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.AsignaturaSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.CierrePeriodoSqlServerAdapter;
...
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.EstudianteProgramaSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.FacultadSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.HorarioDocenteSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.HorarioEstudianteSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.InstitucionSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.MateriaEstudianteSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.ParametroSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.PeriodoAcademicoSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.PlanEstudioSqlServerAdapter;
import co.edu.uco.asistenciasuco.infrastructure.adapter.secondary.academic.SesionMateriaEstudianteSqlServerAdapter;
