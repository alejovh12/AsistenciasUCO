...
public final class ConsultarTiposIdentificacionRepositoryMapper {
    ...
    public static List<TipoIdentificacionConsultadoEntity> toUseCaseEntities(
        ...
        final List<TipoIdentificacionConsultadoEntity> resultado = new ArrayList<>();

        for (final TipoIdentificacionRepositoryEntity entity : entities) {
            resultado.add(new TipoIdentificacionConsultadoEntity(
                    entity.getId(),
