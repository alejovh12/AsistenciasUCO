...
/**
 * Entidad del puerto secundario para filas de dbo.uv_docente.
 */
public final class DocenteAsignacionAcademicaRepositoryEntity {
    ...
    public DocenteAsignacionAcademicaRepositoryEntity(
            final UUID id,
