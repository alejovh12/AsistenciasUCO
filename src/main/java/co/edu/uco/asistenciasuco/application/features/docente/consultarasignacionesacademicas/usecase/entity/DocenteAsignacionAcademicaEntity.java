package co.edu.uco.asistenciasuco.application.features.docente.consultarasignacionesacademicas.usecase.entity;

import java.util.UUID;

/**
 * Modelo interno para una asignacion academica consultada de un docente.
 */
public final class DocenteAsignacionAcademicaEntity {
    ...
    private final boolean estaActivoDocente;
    private final String estaActivoTextoDocente;

    public DocenteAsignacionAcademicaEntity(
            final UUID id,
