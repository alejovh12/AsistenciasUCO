...
/**
 * {@link JwtAuthenticatedUserProvider} solo debe leer {@code Authentication.getName()}
...
class JwtAuthenticatedUserProviderTest {
    ...
    private final JwtAuthenticatedUserProvider provider = new JwtAuthenticatedUserProvider();
