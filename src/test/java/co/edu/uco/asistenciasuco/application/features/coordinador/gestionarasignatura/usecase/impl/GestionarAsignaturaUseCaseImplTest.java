...
class GestionarAsignaturaUseCaseImplTest {
    ...
    void crear_invoca_command_port_con_datos_del_dominio() {
        ...
        final AsignaturaDomain domain = new AsignaturaDomain(null, plan, "COD1", "Calculo", 3, 1, "Area", "Componente");
    ...
    void actualizar_invoca_command_port_con_id_de_asignatura() {
        ...
        final UUID plan = UUID.randomUUID();
        final AsignaturaDomain domain = new AsignaturaDomain(id, plan, "COD1", "Calculo", 3, 1, "Area", "Componente");
