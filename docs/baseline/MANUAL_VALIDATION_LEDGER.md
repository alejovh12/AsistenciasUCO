...
| MV-003 | 2026-09-20 | Logs/metrics/traces y vault/catálogos del ambiente | Config/adapters existentes no demuestran operación | correlationId/traceId/spanId enlazados; métricas; configuración de providers y evidencia sin valores secretos | backend-team + operaciones | PENDIENTE |
