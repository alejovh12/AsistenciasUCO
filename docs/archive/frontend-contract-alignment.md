...
Fuente histórica: `docs/integration/frontend-contract-alignment.md`. No rige nuevas tareas. Sustituido por [frontend-contract-alignment.md](../integration/frontend-contract-alignment.md).
